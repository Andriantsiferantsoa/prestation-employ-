...
<html>
  <head>
    ...
    <title>Gestion de préstation d'employée</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#" id="employe"><i class="fa fa-circle-o"></i> Employé</a></li>
                <li><a href="#" id="entreprise"><i class="fa fa-circle-o"></i> Entreprise</a></li>
                <li><a href="#" id="travail"><i class="fa fa-circle-o"></i> Travail</a></li>
              </ul>
            </li>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="close_emp"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">Modification d'employe</h4>
                  </div>
                ...
                <form role="form" id="form_emp_modif" action="#" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <input type="hidden" id="modif_hide" name="" value="">
...
<!-- liste employe--> 
              ...
              <!-- general form elements -->
                ...
                <form role="form" id="form_emp_suppr" action="#" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <input type="hidden" id="suppr_hide" name="" value="">
                    Voulez-vous Supprimer l'Employe?
<!-- liste employe--> 
                  </div>
                  <div class="box-footer">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="close_emp"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">Ajout d'employe</h4>
                  </div>
                  <div class="modal-body">
                   <div class="box box-primary">
